...
urlpatterns = [
    ...
    path('blogbase/', TemplateView.as_view(template_name='blogbase.html'), name='blogbase'),
    ...
    path('ebase/',
         TemplateView.as_view(template_name='ebase.html'),
         name='ebase'),
    ...
    path('theories/',
         ...
         name='theories'),
    path('donatebase/', TemplateView.as_view(template_name='donatebase.html'), name='donatebase'),
