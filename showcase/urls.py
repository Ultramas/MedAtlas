...
urlpatterns = [
    ...
    path('outcomes/recent/', views.UserRecentOutcomesView.as_view(), name='recent_outcomes'),
    path('users/<int:user_id>/outcomes/recent/', views.UserRecentOutcomesView.as_view(), name='user_recent_outcomes'),
    ...
    path("load-game-wrapper/<int:game_id>/<int:battle_id>/", views.load_game_wrapper,
         name="load_game_wrapper_with_battle"),
