...
urlpatterns = [
    ...
    path('sell/<int:pk>/',  views.GameChestBackgroundView.as_view(), name='sell_game_inventory_object'),
    ...
    path('inventory2/', views.PlayerInventoryView.as_view(), name='inventory2'),
