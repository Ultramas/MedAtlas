# Generated by Django 4.1.10 on 2024-06-22 05:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(help_text='Category of choice (Pokemon, trainers, etc.).', max_length=100)),
                ...
                ('rarity', models.DecimalField(blank=True, decimal_places=4, help_text='Rarity of choice in percent (optional).', max_digits=7, null=True, verbose_name='Rarity (%)')),
                ('number_of_choice', models.IntegerField()),
                ('total_number_of_choice', models.IntegerField(blank=True, null=True)),
                ('lower_nonce', models.DecimalField(blank=True, decimal_places=0, help_text='Lower bound nonce of Choice', max_digits=6, null=True, validators=[django.core.validators.MaxValueValidator(999999), django.core.validators.MinValueValidator(0)])),
                ('upper_nonce', models.DecimalField(blank=True, decimal_places=0, help_text='Upper bound nonce of Choice', max_digits=6, null=True, validators=[django.core.validators.MaxValueValidator(999999), django.core.validators.MinValueValidator(0)])),
                ('nodes', models.IntegerField(blank=True, help_text='Number of the choice included', null=True)),
                ('value', models.DecimalField(blank=True, decimal_places=2, help_text='Value of item in Rubicoins.', max_digits=12, null=True, verbose_name='Value (Rubicoins)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_width', models.PositiveIntegerField(blank=True, default=100, help_text='Original width of the advertisement (use for original ratio).', null=True, verbose_name='image width')),
                ('mfg_date', models.DateTimeField(auto_now_add=True, verbose_name='date')),
                ('position', models.IntegerField(default=1, verbose_name='Currency Numerical Label')),
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('length_for_resize', models.PositiveIntegerField(default=100, verbose_name='Resized Length')),
                ('width_for_resize', models.PositiveIntegerField(default=100, verbose_name='Resized Width')),
                ('image2', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Second image')),
                ('image_length2', models.PositiveIntegerField(blank=True, default=100, help_text='Original length of the advertisement (use for original ratio).', null=True, verbose_name='image length')),
                ('image_width2', models.PositiveIntegerField(blank=True, default=100, help_text='Original width of the advertisement (use for original ratio).', null=True, verbose_name='image width')),
                ('length_for_resize2', models.PositiveIntegerField(blank=True, default=100, null=True, verbose_name='Resized Length')),
                ('width_for_resize2', models.PositiveIntegerField(blank=True, default=100, null=True, verbose_name='Resized Width')),
                ('image3', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Third image')),
                ('image_length3', models.PositiveIntegerField(blank=True, default=100, help_text='Original length of the advertisement (use for original ratio).', null=True, verbose_name='image length')),
                ('image_width3', models.PositiveIntegerField(blank=True, default=100, help_text='Original width of the advertisement (use for original ratio).', null=True, verbose_name='image width')),
                ('length_for_resize3', models.PositiveIntegerField(blank=True, default=100, null=True, verbose_name='Resized Length')),
                ('width_for_resize3', models.PositiveIntegerField(blank=True, default=100, null=True, verbose_name='Resized Width')),
                ('image4', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Fourth image')),
                ('image_length4', models.PositiveIntegerField(blank=True, default=100, help_text='Original length of the advertisement (use for original ratio).', null=True, verbose_name='image length')),
                ('image_width4', models.PositiveIntegerField(blank=True, default=100, help_text='Original width of the advertisement (use for original ratio).', null=True, verbose_name='image width')),
                ('length_for_resize4', models.PositiveIntegerField(blank=True, default=100, null=True, verbose_name='Resized Length')),
                ('width_for_resize4', models.PositiveIntegerField(blank=True, default=100, null=True, verbose_name='Resized Width')),
                ('image5', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Fifth image')),
                ('image_length5', models.PositiveIntegerField(blank=True, default=100, help_text='Original length of the advertisement (use for original ratio).', null=True, verbose_name='image length')),
                ('image_width5', models.PositiveIntegerField(blank=True, default=100, help_text='Original width of the advertisement (use for original ratio).', null=True, verbose_name='image width')),
                ('length_for_resize5', models.PositiveIntegerField(blank=True, default=100, null=True, verbose_name='Resized Length')),
                ('width_for_resize5', models.PositiveIntegerField(blank=True, default=100, null=True, verbose_name='Resized Width')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
                ('experience', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.experience')),
            ],
            options={
                'verbose_name': 'Level',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dealer_trades', to='showcase.userprofile2', verbose_name='Dealer')),
                ('trade_user2', models.ForeignKey(blank=True, help_text='Optional', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recipient_trades', to='showcase.userprofile2', verbose_name='Recipient')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.DecimalField(blank=True, decimal_places=1, default=0.0, max_digits=10, null=True)),
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency_amount', models.DecimalField(decimal_places=1, default=0.0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('color', models.CharField(blank=True, choices=[('Gra', 'Gray'), ('Gre', 'Green'), ('Y', 'Yellow'), ('O', 'Orange'), ('R', 'Red'), ('B', 'Black')], max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mfg_date', models.DateTimeField(auto_now_add=True, verbose_name='date')),
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
                ('prize', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.exchangeprize')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('usercard', models.ManyToManyField(to='showcase.inventoryobject')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='choice',
            name='game',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='choices', to='showcase.game'),
        ),
        migrations.AddField(
            model_name='choice',
            name='prizes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('battle_name', models.CharField(blank=True, help_text='Your name and tag go here.', max_length=100, null=True)),
                ...
                ('chests', models.ManyToManyField(to='showcase.game')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.currency')),
                ('participants', models.ManyToManyField(blank=True, limit_choices_to={'is_bot': False}, related_name='battles', to='showcase.battleparticipant')),
                ('robots', models.ManyToManyField(blank=True, limit_choices_to={'is_bot': True}, related_name='battles', to='showcase.robot')),
            ],
            options={
                'verbose_name': 'Battle',
                'verbose_name_plural': 'Battles',
