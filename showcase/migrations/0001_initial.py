    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tier', models.CharField(blank=True, choices=[('C', 'Common'), ('U', 'Uncommon'), ('R', 'Rare'), ('E', 'Epic'), ('M', 'Mythical'), ('T', 'Transcendent'), ('P', 'Primordial'), ('L', 'Legendary'), ('U', 'Ultimate'), ('F', 'Final')], max_length=1, null=True)),
        ...
        migrations.AddField(
            ...
            name='chest',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.game'),
        ),
        migrations.AddField(
            model_name='favoritechests',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome_created', models.BooleanField(blank=True, default=0, null=True)),
