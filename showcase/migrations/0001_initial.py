# Generated by Django 4.1.10 on 2024-01-10 20:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rarity', models.DecimalField(blank=True, decimal_places=4, help_text='Rarity of choice in percent (optional).', max_digits=7, null=True)),
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
