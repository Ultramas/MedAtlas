# Generated by Django 5.1.6 on 2025-04-19 19:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('robot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.robot')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filters', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.blogfilter', verbose_name='Hashtag filters')),
                ('category', models.ForeignKey(blank=True, help_text='Optional', null=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.blogheader', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('S', 'Sale'), ('B', 'Bonus')], default='B', max_length=1)),
                ...
                ('currency_amount', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_length', models.PositiveIntegerField(blank=True, default=100, help_text='Original length of the advertisement (use for original ratio).', null=True, verbose_name='image length')),
                ('image_width', models.PositiveIntegerField(blank=True, default=100, help_text='Original width of the advertisement (use for original ratio).', null=True, verbose_name='image width')),
                ('color', models.CharField(blank=True, choices=[('gray', 'Gray'), ('green', 'Green'), ('yellow', 'Yellow'), ('orange', 'Orange'), ('red', 'Red'), ('black', 'Black'), ('gold', 'Gold')], max_length=6, null=True)),
                ...
                ('midcategory', models.CharField(blank=True, help_text='Middle category of choice.', max_length=200, null=True)),
                ...
                ('value', models.IntegerField(blank=True, help_text='Value of item in Rubies.', null=True, verbose_name='Value (Rubies)')),
                ('number', models.IntegerField(blank=True, default=1, help_text='Position ordered by value (from highest to lowest)', null=True)),
                ('total_number', models.IntegerField(blank=True, default=1, help_text='Position ordered by value (from highest to lowest)', null=True)),
                ('card_id', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('set_series', models.CharField(blank=True, max_length=100, null=True)),
                ('set_release_date', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.currencymarket')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.currency')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.currencyorder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome_created', models.BooleanField(default=False, help_text="Has this game's outcome been generated for this battle?")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.IntegerField(blank=True, null=True)),
                ('rarity', models.DecimalField(blank=True, decimal_places=6, help_text='Rarity of choice in percent (optional).', max_digits=9, null=True, verbose_name='Rarity (%)')),
                ('lower_nonce', models.IntegerField(blank=True, help_text='Lower bound nonce of Choice', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1000000)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(blank=True, max_length=64, null=True, unique=True, validators=[django.core.validators.MinLengthValidator(16)])),
                ('serial', models.BigIntegerField(blank=True, null=True, unique=True)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('expiration_date', models.DateTimeField(default=showcase.models.default_expiration)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Is this an active order?')),
                ('chest', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.game')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.itemfilter')),
            ],
        ),
        migrations.CreateModel(
            name='ImageCarousel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.currency')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('monstrositysprite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.monstrositysprite', verbose_name='Monstrosity Sprite')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderprice', models.FloatField(default=0, verbose_name='Order price')),
                ('currencyorderprice', models.IntegerField(default=0, verbose_name='Curency order price')),
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('refund_requested', models.BooleanField(default=False)),
                ('refund_granted', models.BooleanField(default=False)),
                ('stripe_transaction_id', models.CharField(blank=True, help_text='Stripe charge ID', max_length=255, null=True)),
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Is this an active order?')),
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='showcase.coupon')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('green_cards_hit', models.IntegerField(blank=True, default=0, null=True)),
                ('yellow_cards_hit', models.IntegerField(blank=True, default=0, null=True)),
                ('orange_cards_hit', models.IntegerField(blank=True, default=0, null=True)),
                ('red_cards_hit', models.IntegerField(blank=True, default=0, null=True)),
                ('black_cards_hit', models.IntegerField(blank=True, default=0, null=True)),
                ('gold_cards_hit', models.IntegerField(blank=True, default=0, null=True)),
                ('red_gold_cards_hit', models.IntegerField(blank=True, default=0, null=True)),
                ('cards_counter', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
                ('currency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.currency')),
                ('favorite_chests', models.ManyToManyField(blank=True, to='showcase.favoritechests')),
                ('level', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='showcase.level')),
                ('level_icon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.levelicon')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ref_code', models.CharField(blank=True, max_length=20, null=True)),
                ('orderprice', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=20, verbose_name='Order price')),
                ('currencyorderprice', models.IntegerField(default=0, verbose_name='Currency order price')),
                ...
                ('shipping_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shipping_address', to='showcase.address')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('stream', 'Streamlined View'), ('detail', 'Detailed View')], default='stream', max_length=6)),
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Set active?')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='showcase.userprofile2'),
        ),
        migrations.AddField(
            model_name='trade',
            name='trade_user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees', models.IntegerField(blank=True, default=599, null=True)),
                ...
                ('withdraw_state', models.CharField(choices=[('I', 'Incomplete'), ('C', 'Complete'), ('CA', 'Cancelled')], default='I', max_length=2)),
                ('capacity_state', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], default='N', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('status', 'pending')), fields=('initiator', 'receiver', 'status'), name='unique_pending_trades')],
            },
        ),
        migrations.CreateModel(
            name='Ballot',
