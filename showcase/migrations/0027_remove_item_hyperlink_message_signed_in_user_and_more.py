...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('showcase', '0026_remove_message_signed_in_user_item_hyperlink_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='feedback',
            name='slug',
            field=models.SlugField(help_text='Leave blank to use corresponding product slug.', max_length=200),
        ),
        migrations.AlterField(
            model_name='feedback',
            name='username',
