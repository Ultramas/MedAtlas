# Generated by Django 4.1.10 on 2024-02-29 03:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.IntegerField(blank=True, choices=[(1, 'Active'), (0, 'Inactive')], default=1, help_text='1->Active, 0->Inactive', null=True, verbose_name='Out of stock?')),
                ('offered_trade_items', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='showcase.tradeoffer')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Dealer', to=settings.AUTH_USER_MODEL)),
                ...
                ('wanted_trade_items', models.ManyToManyField(to='showcase.tradeitem')),
            ],
            options={
