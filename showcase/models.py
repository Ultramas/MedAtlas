...
class Post(models.Model):
   ...
   catagory = models.CharField(max_length=100,help_text='Choose a catagory you want your idea to affect (server layout, event idea, etc).')
...
class Poste(models.Model):
   name = models.CharField(max_length=100, help_text='Your name goes here.')
   catagory = models.CharField(max_length=100,help_text='Type the catagory that you are voting on (server layout, event idea, administration position, etc).')
   description = models.TextField(help_text='Please share any ideas you may have.')
...
class StaffApplication(models.Model):
   ...
   I_have_been_in_MC_for_at_least_2_months = models.BooleanField(verbose_name="I have been in MC for at least 2 months", default=False, choices=((True, 'Yes'), (False, 'No')))
   I_have_been_in_a_previous_role_for_at_least_1_month = models.BooleanField(verbose_name="I have been in MC for at least 1 month", default=False, choices=((True, 'Yes'), (False, 'No')))
   I_can_attend_at_least_half_of_the_staff_meetings = models.BooleanField(verbose_name="I can attend at least half of the staff meetings.", default=False,choices=((True, 'Yes'), (False, 'No')))
   I_have_no_strikes_on_my_account_currently = models.BooleanField(verbose_name="I have no strikes on my account currently", default=False, choices=((True, 'Yes'), (False, 'No')))
   role = models.TextField(help_text='What role are you applying for?',verbose_name="Roles")
   Why_do_you_want_to_apply_for_staff = models.TextField(help_text='Tell us why you want to be a MegaClan Staff Member. Be descriptive.',verbose_name="Why do you want to apply for staff?")
...
class PunishAppeal(models.Model):
   ...
   Rule_broken = models.CharField( max_length=200, help_text='Tell us the numbers of the rule(s) you broke. Refer to our rules page to see the rules and their corresponding numbers.', verbose_name="rule broken: ")
...
class BanAppeal(models.Model):
   name = models.CharField(max_length=100, help_text='Your name and tag go here.')
   Rule_broken = models.CharField(max_length=200, help_text='Tell us the numbers of the rule(s) you broke. Refer to our rules page to see the rules and their corresponding numbers.')
...
class Support(models.Model):
   name = models.CharField(max_length=100, help_text='Your name and tag go here. If you wish to stay anonymous, put "Anonymous".')
   catagory = models.CharField(max_length=200, help_text='Please let us know what type of issue you are dealing with.')
...
class Event(models.Model):
   ...
   catagory = models.CharField(max_length=200,help_text='Please let us know what type of event this is (tournament, stage night, etc).')
...
class ImageCarousel(models.Model):
   ...
   carouselimage = models.ImageField(help_text='Link a URL for your profile (scales to your picture`s dimensions.)', upload_to='images/', verbose_name='image')
...
class AdvertisementBase(models.Model):
   advertisementtitle = models.CharField(max_length=100, help_text='Advertisement title.', verbose_name="advertisement title")
