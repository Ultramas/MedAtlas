    ...
    async function randomizeContents() {
        ...
        ${attributes.file ? `<div class="sliderImg" style="background-color: {{ color }}; background-image: url(${attributes.file}); background-repeat: no-repeat; background-position: center; background-size: contain; height: 10em; width: 100%;"></div>` : ''}
        <div class="sliderPrice" style="background-color: {{ color }};">${attributes.value} 💎</div>
    </div>
`;
